...
def detect_hough_line_canny(img: np.ndarray,is_plot_edges: bool) -> np.ndarray:
    """
    Detect the lines in an image.
...
def detect_hough_line_sobel(img: np.ndarray,is_plot_edges: bool,len_kernel:int =40):
